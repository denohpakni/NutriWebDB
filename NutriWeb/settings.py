"""
Django settings for NutriWeb project.
...
WSGI_APPLICATION = 'NutriWeb.wsgi.application'
...
EMAIL_HOST_USER = 'contact@labworks.xyz'
EMAIL_HOST_PASSWORD = 'dmm9831'
EMAIL_PORT = 587 
EMAIL_USE_TLS = True
